...
const team: Team[] = [
  ...
  {
    name: "Claudinha Domingues",
    role: "Advogada Linda",
    image: "/team1.jpeg",
  },
  {
    name: "Frank Maldonado",
    role: "Causas Cíveis",
    image: "/team3.jpeg",
  },
  ...
  {
    name: "Ricardo Melo",
    role: "Causas Criminais de Porta de Cadeia",
    image: "/team2.jpeg",
  },
];
...
const TeamSection = () => {
  return (
    <Box id="team" sx={{ py: 4 }}>
      ...
      >
        Algumas das nossas centenas de trabalhos ao redor do mundo, feitos com
